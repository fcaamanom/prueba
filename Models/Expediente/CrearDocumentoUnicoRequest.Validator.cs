...
{
    public class CrearDocumentoUnicoRequestValidator : AbstractValidator<CrearDocumentoUnicoRequest>
    {
        public CrearDocumentoUnicoRequestValidator()
        {
            ...
            RuleFor(x => x.Nacionalidad)
                .NotEmpty().WithMessage("El campo 'Nacionalidad' es requerido.")
                .Length(3).WithMessage("El campo 'Nacionalidad' debe tener una longitud de 3 caracteres.");
